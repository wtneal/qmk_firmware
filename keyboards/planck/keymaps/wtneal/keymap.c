 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | FN   |      | GUI  | Alt  |Lower |    Space    |Raise | Shift|      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {MO(_FUNC), XXXXXXX, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RSFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_FUNC] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT},
